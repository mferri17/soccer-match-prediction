...
% TODO: inserire inferenze fatte con UI
...
Media accuracy su 10 fold: 0.6257504
\\
\begin{table}[!h]
	\centering
	\caption{10 fold cross validation SVM}\label{tab:precision_recall_f1_10fold_binary}
...
Media accuracy su 10 fold: 0.5126205

Media su 10 fold per ogni classe:

\begin{table}[!h]
	\centering
	\caption{10 fold cross validation SVM}\label{tab:precision_recall_f1_10fold_multiclass}
	\begin{tabular}{l|llll}
		\hline
		Classe & Precision & Recall & F1 \\
		\hline
