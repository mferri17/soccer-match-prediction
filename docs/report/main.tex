...
Per non dover ricreare configurazioni dall'inizio ogni qualvolta si avvii l'applicazione inoltre, nella parte superiore destra dello schermo sono presenti dei tasti per salvare e caricarne di precedenti, come mostrato nelle figure \ref{fig:config} \subref{fig:save_config} e \ref{fig:config} \subref{fig:load_config}.
